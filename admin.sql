...
-- Moved to admin-limits.sql, which is its own file so that it gets noticed and
-- run. Caps on coins and XP, no gifting yourself, nothing from Afterburn, and
-- the author stamp that signs announcements all live there.
